...
/* Setting Hex colour map*/
$colorMap = [
    "0" => '#c78086', //jingga tua
    "1" => '#c39f82', //kuning muda
    "2" => '#cfc17f', //kuning pastel
    "3" => '#7fbcb3', //hijau pastel
    "4" => '#7bc4ed', // Biru pastel
    "5" => '#93b5de', //biru pastel putih
    "6" => '#b8b4d7', //ungu pastel
    "7" => '#b5bec6', //abu-abu
    "8" => '#7aaacf', //abu tua/biru
    "9" => '#9bad85' //orange
];
...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
    ...
    // Dalam bagian loop yang menghasilkan label dan barcode
// Dalam bagian loop yang menghasilkan label dan barcode
foreach ($chunked_label_arrays as $label_data) {
    ...
    foreach ($label_data as $labels) {
        ...
        $html_str .= '<div class="card card-body">';
        
        // Pindahkan labelHeaderStyle ke dalam .card-body, di atas label dan barcode
        ...
        $html_str .= '<div style="width:250px; margin-left: 0px">';
...
<html lang="en">
    <head>
        ...
        <style>
            ...
            border: 1px solid #ccc; /* Tambahkan border untuk visualisasi */
            box-sizing: border-box; /* Pastikan padding dan border termasuk dalam ukuran */
            overflow: hidden; /* Hindari konten meluber */
            }

            .card-body {
            padding: 0.5cm; /* Padding di dalam card-body */
            display: flex;
            flex-direction: column;
             /* Atur jarak antara header dan konten */
            
            width: 14cm; /* Lebar kartu 10 cm */
            height: 6cm; /* Tinggi kartu 4 cm */
            }
            

            .labelHeaderStyle {
            border-bottom: 0px solid #8d8d8d;
            padding-bottom: 10px; /* Padding bawah header */
            margin-bottom: 0.2cm; /* Margin bawah header */
            width: 100%; /* Lebar penuh */
            text-align: center; /* Pusatkan teks header */
            font-size: 18pt; /* Ukuran font header */
            font-weight: 400; /* Tebalkan teks header */
            vertical-align: middle; 
            }

            .labelStyle {
            font-weight: bold;
            font-size: 18pt; /* Ukuran font untuk label teks */
            line-height: 1.2; /* Tinggi baris untuk label teks */
            }

            img.img-fluid {
            max-width: 100%; /* Pastikan barcode tidak melebihi lebar container */
            height: auto; /* Pertahankan rasio aspek barcode */
            font-size: 18pt;
            padding: 10px;
            align-content: left;
            }
